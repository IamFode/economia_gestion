...
\subsubsection{Supuesto 2 SLR.2.- Muestro aleatorio}
\begin{tcolorbox}[colframe=white]
...
Ahora tomemos el hecho de que $\sum\limits_{i=1}^n (x_i-\overline{x})y_i = \sum\limits_{i=1}^n (x_i-\overline{x})y_i$ para escribir el estimador de la pendiente de $MCO$ como sigue: 
\begin{equation}
...
Sustituyendo la ecuación $y_i = \beta_0 + \beta_1 x_i + \epsilon_i$ dentro (2.30) tenemos que 
...
Dado que $\sum\limits_{i=1}^n (x_i-\oerline{x}) = 0$ y $$
