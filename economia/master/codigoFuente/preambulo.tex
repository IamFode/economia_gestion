...
% ------------------- Paquetes ----------------------
\usepackage[text=17cm,left=2.54cm,right=2.54cm, headsep=20pt, top=2.54cm, bottom = 2.54cm,letterpaper,showframe = false]{geometry} %configuración página
...
%---------------------------------
\titleformat*{\section}{\big\bfseries}
